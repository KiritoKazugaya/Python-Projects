...
def date_time():
    ...
    month = time.strftime("%b")  # Short Month (e.g., Jan, Feb)
    year = time.strftime("%Y")
    day = time.strftime("%a")  # Short Day (e.g., Mon, Tue, Wed)
...
# Date portion
lab_date = Label(clock, text="00", font=('Times New Roman', 30, 'bold'), bg='red', fg='white')
...
lab_mo = Label(clock, text="00", font=('Times New Roman', 30, 'bold'), bg='red', fg='white')
...
lab_year = Label(clock, text="00", font=('Times New Roman', 30, 'bold'), bg='red', fg='white')
